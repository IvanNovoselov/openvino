...
public:
    /** @brief Empty constructor for derived classes. It does not initialize any KernelEmitter fields
     * @param h jit code generator
     * @param isa supported instruction set
     */
...
protected:
    ...
    */
    ...
    /**
    * @brief initializes KernelEmitter fields that could be derived from the Kernel op.
     * Note: this method should work both for dynamic and static Kernels.
     * @arg kernel - snippets::op::Kernel passed to the KernelEmitter constructor
    */
    void init_body_parameters(const ov::snippets::lowered::ExpressionPtr& expr);
