...
TEST_F(SnippetsCollapseSubgraphTests, StartSubgraphMultipleOutputs) {
    function = ngraph::builder::subgraph::AddSubtractMultiplyFunction::getOriginal();
    function_ref = ngraph::builder::subgraph::AddSubtractMultiplyFunction::getReference();
    run(true);
}
