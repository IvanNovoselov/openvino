...
TEST_F(SnippetsCollapseSubgraphTests, smoke_Snippets_Eltwise) {
...
TEST_F(SnippetsCollapseSubgraphTests, smoke_Snippets_MatMulWithEltwise) {
...
TEST_F(SnippetsCollapseSubgraphTests, smoke_Snippets_AvoidLoopEltwise) {
