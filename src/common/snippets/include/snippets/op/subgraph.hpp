...
public:
    ...
    snippets::Schedule generate_from_linear_ir(const lowered::pass::PassPipeline& pre_common = {},
                                               const lowered::pass::PassPipeline& post_common = {},
    ...
    convert_body_to_linear_ir(const std::shared_ptr<IShapeInferSnippetsFactory>& factory = std::make_shared<IShapeInferSnippetsFactory>());
